          ...
          >
            <EliteCard glow="violet" className="h-full">
              <div className="p-6 sm:p-8">
                <h2 className="font-display text-lg font-bold text-ink-primary">Send us a message</h2>
          ...
          <div className="flex flex-col gap-4 lg:col-span-5">
            ...
            <div className="grid grid-cols-1 gap-3 sm:grid-cols-2 lg:grid-cols-1">
              {CONTACT_OPTIONS.filter(
                (o) => o.title !== "Head Office" && o.title !== "US Office" && o.title !== "Email us"
              ).map((option, index) => (
                <motion.div
                  key={option.title}
                ...
                >
                  <EliteCard glow={option.glow} className="h-full">
                    <a href={option.href} className="group flex items-center gap-4 p-4">
                      <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-xl border border-accent-violet/20 bg-accent-violet/10 text-accent-violet transition-transform group-hover:scale-110">
